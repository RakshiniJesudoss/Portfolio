...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className="home_title">Rakshini Jesudoss
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home_subtitle">Application Developer</h3>
        <p className="home_description">Blending creativity and technology to develop user-friendly applications that not only look great but also deliver seamless and efficient experiences.
        </p>
